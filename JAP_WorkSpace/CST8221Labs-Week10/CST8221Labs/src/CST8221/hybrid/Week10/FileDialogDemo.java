...
/**
 * This class demonstrates how to use the Swing FileChooser class to open and
 * save files.
 * 
 * @author Sv. Ranev
 * @version 1.19.1
...
public class FileDialogDemo extends JPanel implements ActionListener {
	...
	public FileDialogDemo() {
		...
		/*
		 * The following lines allow you to try a different file selection modes. The
		 * defauld mode is FILES_ONLY
		 */
	...
	/**
	 * Puts the GUI into a frame and makes it visible. For thread safety, this
