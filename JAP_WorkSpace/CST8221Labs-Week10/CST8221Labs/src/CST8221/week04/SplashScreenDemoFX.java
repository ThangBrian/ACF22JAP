 ...
 * below: https://docs.oracle.com/javafx/2/deployment/preloaders.htm
 * 
 * @version 1.20.1
...
public class SplashScreenDemoFX extends Application {
	...
	public void start(Stage primaryStage) {
		 ...
		 * The splash stage is closed after some initial delay and the primary stage is
		 * displayed. A Timer object is used to provide the delay. The delay is 5000
		 * msec (5 sec). The Timer object calls the actionPerformed() method of the
		 * ActionListener after an initial delay. Since the actionPerformed() method
		 * executes on the event-dispatch thread the code must use Platform.runLater()
		 * to execute the JavaFX code on the application thread.
		 */

		// create an ActionListener object using an anonymous inner class implementing
		// ActionListener
		ActionListener listener = new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				// Run the code closing the splash stage and showing the primary stage on the
				// application thread
				// Anonymous inner class implementing Runnable() is used to provide a parameter
				// for runLater()
