...
public class Week11 {
	...
	public void invokeWeek11(int lab, boolean usesJFX, String[] args) {
		...
		case 4:
			...
			break;
		case 5:
			example_w115a(); // Echo protocol (server)
			break;
		case 6:
			example_w115b(); // Echo protocol (client)
			break;
		case 7:
			example_w116a(); // Knock protocol (server)
			break;
		case 8:
			example_w116b(); // Knock protocol (client)
			break;
		case 9:
			example_w117(); // Thread server
			break;
		case 10:
			example_w118(); // Thread client
			break;		default: // invalid lab
