...
import CST8221.hybrid.Week10.CopyBytes;
import CST8221.hybrid.Week10.FileDialogDemo;
import CST8221.hybrid.Week10.JavaFXFileChooserDemo;
import CST8221.hybrid.Week10.Password;
import CST8221.hybrid.Week11.QuoteClient;
...
public class Week00_Hybrid {
	...
	public void invokeHybrid(int lab, boolean usesJFX, String[] args) {
		...
		// Week 10 Hybrid examples ................................................
		case 101:
			hybrid101(); // Basic files
			break;
		case 102:
			hybrid102(); // Basic input
			break;
		case 103:
			hybrid103(); // Basic input
			break;
		case 104:
			if (usesJFX) {
				if (!Main.JFXLaunched) {
					Main.JFXLaunched = true;
					hybrid104(args); // Input files
				} else {
					errorMessage = "You can execute JavaFX only once!";
					JOptionPane.showMessageDialog(null, errorMessage);
				}
		...
		// Week 11 Hybrid examples ................................................
		case 111:
			hybrid111(); // UDP Client
			break;
	...
	/**
	 * Method for week 10 - example 1 - Inputs
	 */
	public void hybrid101() {
		System.out.println("Hybrid Week 10 / Ex 1: Copy files...");
		CopyBytes fileTest = new CopyBytes();
		try {
			fileTest.execute();
		} catch (IOException e) {
	...
	/**
	 * Method for week 10 - example 2 - Password
	 */
	public void hybrid102() {
		System.out.println("Hybrid Week 10 / Ex 2: Password...");
		Password fileTest = new Password();
		try {
			fileTest.execute();
		} catch (IOException e) {
			// TODO Auto-generated catch block
	...
	/**
	 * Method for week 10 - Hybrid 3: File Dialog
	 */
	public void hybrid103() {
		System.out.println("Hybrid Week 10 / Ex 3: Dialogs...");
		FileDialogDemo fileDialog = new FileDialogDemo();
		fileDialog.execute();
	}

	/**
	 * Method for week 10 - Hybrid 4: File Dialog FX
	 * @param args arguments.
	 */
	public void hybrid104(String[] args) {
		System.out.println("Hybrid Week 10 / Ex 4: JavaFX Chooser...");
		JavaFXFileChooserDemo fileDialog = new JavaFXFileChooserDemo();
		fileDialog.execute(args);
	}

	// HYBRID (WEEK 11) ..................................................

	/**
	 * Method for week 11 - example 1 - UDP protocol (Quote)
	 */
	public void hybrid111() {
		System.out.println("Hybrid Week 11 / Ex 1: UDP Protocol...");
		String[] args = { "localhost" };
		QuoteClient netSample = new QuoteClient();
		try {
